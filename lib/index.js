...
import { extractSceneMainImage, extractSceneMainImageFromDir, extractSceneManifest, extractSceneLayer, extractTexVideoMp4, collectSceneVideoFiles, parsePkg, readPkgEntry, scanSceneAudio, scanSceneVideo,
  // ①(2026-09-21 音频格式补全) MIME 表**只此一份**（docs/AUDIO-TRACK-SPEC.md §1.2/§3）：路由侧原先各自
  //   内联一份扩展名三元链 + 一份魔数嗅探，已与渲染器支持的后缀漂移（.oga/.m4a/.aac 缺失、ftyp 偏移写错）。
  suffixAudioMime, audioMimeFor, AUDIO_SUFFIX_MIME } from './pkg-extract.js';
