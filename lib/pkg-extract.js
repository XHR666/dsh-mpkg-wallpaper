 ...
 *  而不是主图）。这些永远不是壁纸主图。 */
const UI_PENALTY_RE =
  /提示框|赞助|水印|按钮|图标|边框|弹窗|文字|角标|prompt|text_|button|icon|logo|dialog|input|chat|badge|bubble|tooltip|border|sponsor|watermark|topbar|titlebar|headbar|notify|hud|overlay|panel|label/i;
