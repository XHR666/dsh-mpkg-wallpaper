...
function readSection() {
		...
		function applyFromStorageInner() {
			...
			try { applyCompatBridges(); startCompatObserver(); } catch {}
		...
		const COMPAT_BRIDGES = [
			...
			['aside, [class*="_sidebar_"]', 'sidebarCol', null],
			['header, [class*="_header_"], [class*="_floatHeader_"]', 'wSkVaW_header', 'wide'],
			['[class*="_root_"], main', 'wSkVaW_root', 'wide'],
			['[class*="_scrollBody_"], [class*="_chatScroll_"]', 'wSkVaW_scrollBody', null],
			['[data-composer-card], [class*="_composerSeat_"]', 'wSkVaW_composerSeat', null]
		];
		let compatObserver = null;
		function applyCompatBridges() {
			try {
		...
		function startCompatObserver() {
			try {
				...
				compatObserver = new MutationObserver(() => { applyCompatBridges(); });
