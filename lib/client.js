			...
			return h("div", { className: "mpw_row mpw_glassHost" }, [
				...
				(section.image || section.webUrl) ? h("div", { className: "mpw_field" }, [
					...
					h("div", { className: "mpw_inline" }, [
						...
						(section.converted === "mp4" || section.converted === "web") ? h("button", { className: "mpw_reset", type: "button", onClick: () => { toggleWallPause(); setWallPausedByUser(!wallPausedByUser); } }, (wallUserPaused || wallPausedByUser) ? t("pause.play") : t("pause.pause")) : null,
