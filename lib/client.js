...
.mpw_repoLink:hover { color: var(--dsw-alias-label-primary); }
		...
		function MpkgSection(props) {
			...
			return h("div", { className: "mpw_row" }, [
				...
				h("div", { className: "mpw_titleRow" }, [
					...
					h("a", { className: "mpw_repoLink", href: "https://github.com/XHR666/dsh-mpkg-wallpaper", target: "_blank", rel: "noopener" }, "XHR666/dsh-mpkg-wallpaper"),
							...
							h("div", { className: "mpw_inline", style: { alignItems: "flex-start", flexWrap: "nowrap" } }, [
								...
								h("div", { className: "mpw_thumb" }, [
									...
									(w.type === "video" || w.converted === "mp4")
										? h("video", { className: "mpw_thumbImg", src: w.image, muted: true, playsInline: true, preload: "metadata",
											onError: (ev) => { ev.target.style.display = "none"; } })
										: h("img", { className: "mpw_thumbImg", src: w.image, alt: "", loading: "lazy",
											onError: (ev) => { ev.target.style.display = "none"; } })
								]),
