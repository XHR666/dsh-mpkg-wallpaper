window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function applyFromStorage() {
			...
			// ①(诊断) 定位 clear 后导入星野不显示：web 分支判断前打印关键字段
			try { if (section.webUrl || section.converted === "web") console.log("[dsh-mpkg-wallpaper][web判定]", JSON.stringify({ webUrl: section.webUrl, converted: section.converted, image })); } catch {}
