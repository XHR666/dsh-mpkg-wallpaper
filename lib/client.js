...
[role="menu"], [class*="_menu_"], [class*="_popover_"], [class*="_floatHeader_"],
[data-dockkit-pane], [class*="_panel_"]:not([class*="_sidebar_"]) {
  ...
  /* ②(修复 2026-09-11) 新版菜单 position:fixed;z-index:70 低于聊天区元素 → 展开面板被聊天文字盖住。
     提层到 4000（不改变其 fixed 定位/布局）；不改 position 以免破坏 dsh 的坐标计算。 */
		...
		function setupSblurObserver() {
			...
			const check = () => {
				try {
					...
					const hasDlg = Array.from(document.querySelectorAll('[role="dialog"], [role="alertdialog"], [class*="_overlay_"], [class*="_modal_"], [class*="_dialog_"], [class*="_settings_"]')).some(isFullDlg)
