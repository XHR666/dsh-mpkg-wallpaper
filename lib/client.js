...
`;
		...
		function MpkgSection(props) {
			...
			return h("div", { className: "mpw_row" }, [
				// ①(新) 设置页顶部 Tab：分类切换，减少滚动
				h("div", { className: "mpw_tabBar" }, [
					h("button", { className: "mpw_tab mpw_tabActive", type: "button", onClick: () => setSettingsTab("source") }, t("sec.source")),
					h("button", { className: "mpw_tab", type: "button", onClick: () => setSettingsTab("appearance") }, t("sec.appearance")),
					h("button", { className: "mpw_tab", type: "button", onClick: () => setSettingsTab("unify") }, t("sec.unify")),
					h("button", { className: "mpw_tab", type: "button", onClick: () => setSettingsTab("blur") }, t("sec.blur")),
					h("button", { className: "mpw_tab", type: "button", onClick: () => setSettingsTab("show") }, t("sec.show")),
					h("button", { className: "mpw_tab", type: "button", onClick: () => setSettingsTab("aqua") }, t("sec.aqua")),
					h("button", { className: "mpw_tab", type: "button", onClick: () => setSettingsTab("other") }, t("sec.other")),
				]),
				// source 组（含标题/描述）
