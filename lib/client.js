			...
			return h("div", { className: "mpw_row" }, [
				...
				h("div", { className: "mpw_field" }, [
					...
					h("div", { className: "mpw_inline", style: { marginTop: 4 } }, [
						h("select", { className: "mpw_input", style: { flex: 1, minWidth: 0 }, value: section.rotGroupId || "",
							onChange: (ev) => commit({ rotGroupId: ev.target.value }, true) },
							h("option", { value: "" }, t("rot.all")),
							(section.rotGroups || []).map((g) => h("option", { value: g.id, key: g.id }, g.name + "（" + (g.keys || []).length + "）"))
						),
				...
				// ⑳(新) 轮播列表管理弹窗（新建/编辑/删除）
				rotModal ? h("div", { className: "mpw_mask", onClick: () => setRotModal(false) }, [
				...
				rotEditor && rotEdit ? h("div", { className: "mpw_mask", onClick: () => setRotEditor(false) }, [
					h("div", { className: "mpw_dialog", style: { width: "min(560px, calc(100vw - 32px))" }, onClick: (ev) => ev.stopPropagation() }, [
				...
				// ⑳(新) 视频倍速（原生 playbackRate，0.5-2x 六档，即时生效不重载）
				h("div", { className: "mpw_field" }, [
					h("label", { className: "mpw_label" }, t("speed")),
					h("div", { className: "mpw_inline" }, SPEED_LEVELS.map((rate) => h("button", {
						className: "mpw_miniBtn" + ((section.playbackRate !== void 0 ? section.playbackRate : DEFAULT_PLAYBACK_RATE) === rate ? " mpw_on" : ""),
						type: "button", key: rate,
						onClick: () => commit({ playbackRate: rate }, true)
					}, (rate === 1 ? "1x" : rate + "x")))),
				...
				webConfirm ? h("div", { className: "mpw_mask", onClick: () => setWebConfirm(null) }, [
					h("div", { className: "mpw_dialog", onClick: (ev) => ev.stopPropagation() }, [
