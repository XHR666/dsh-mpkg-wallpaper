...
`;
			...
			if ((section.glassColor && /^#[0-9a-fA-F]{6}$/.test(section.glassColor)) || (section.glassAlpha !== void 0 && section.glassAlpha > 0)) {
				const gc = section.glassColor && /^#[0-9a-fA-F]{6}$/.test(section.glassColor)
					? section.glassColor
					: (document.body && document.body.hasAttribute("data-ds-dark-theme") ? "#1a2030" : "#eef1f6");
				const ga = Math.max(0, Math.min(60, section.glassAlpha !== void 0 ? section.glassAlpha : 12));
				css += `
...
body[data-mpw-glass] [role="dialog"],
...
body[data-mpw-theme] {
	--dsw-alias-specific-sidebar-fill: color-mix(in srgb, var(--mpw-theme-color, #3964fe) 26%, var(--dsw-alias-bg-base, #0e1420));
}
body[data-mpw-theme] .pI_x6G_sidebarCol,
body[data-mpw-theme] .hHd-Xa_root {
	background-color: color-mix(in srgb, var(--mpw-theme-color, #3964fe) 26%, var(--dsw-alias-bg-base, #0e1420)) !important;
}
body[data-mpw-theme] .wSkVaW_header {
	background-color: color-mix(in srgb, var(--mpw-theme-color, #3964fe) 40%, var(--dsw-alias-bg-base, #0e1420)) !important;
}
body[data-mpw-theme] .hHd-Xa_newSession {
	background-color: color-mix(in srgb, var(--mpw-theme-color, #3964fe) 48%, var(--dsw-alias-bg-base, #0e1420)) !important;
}
body[data-mpw-theme] [role="dialog"] {
	background-color: color-mix(in srgb, var(--mpw-theme-color, #3964fe) 18%, var(--dsw-alias-bg-base, #0e1420)) !important;
}
`;
			}
