		...
		function MpkgSection(props) {
			...
			const resetSettings = () => {
				...
				writeSection(Object.assign({}, keep, {
					...
					bsCompat: false, bsFloat: false, bsFont: false, bsReveal: false, bsAlpha: false, bsAqua: false,
			...
			const BACKUP_FIELDS = [
				...
				"fpsCap", "resMax", "bsCompat", "bsFloat", "bsFont", "bsReveal", "bsAlpha", "bsAqua"
			];
			const exportBackup = () => {
				try {
					const s = readSection();
