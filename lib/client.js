...
/* 内容区：flex 行 + translateX 真滑动（翻页效果）；所有 tab 始终挂载，hooks 稳定 */
.mpw_tabBody {
	display: flex; overflow: hidden; min-height: 60px;
...
`;
		...
		function MpkgSection(props) {
			...
			return h("div", { className: "mpw_row" }, [
				...
				h("div", { className: "mpw_tabBody", style: { transform: "translateX(-" + TAB_ORDER.indexOf(settingsTab) * 100 + "%)" } }, [
				// source 组
