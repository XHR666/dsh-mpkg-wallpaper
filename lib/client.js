...
html body:not(:has([class*="_overlay"])):not(:has([class*="_modal"])):not(:has([class*="_portal"])) [data-sidebar-right-panel],
html body:not(:has([class*="_overlay"])):not(:has([class*="_modal"])):not(:has([class*="_portal"])) [data-sidebar-right-float-host],
html body:not(:has([class*="_overlay"])):not(:has([class*="_modal"])):not(:has([class*="_portal"])) [data-mpw-rs],
html body:not(:has([class*="_overlay"])):not(:has([class*="_modal"])):not(:has([class*="_portal"])) [data-dockkit-strip],
html body:not(:has([class*="_overlay"])):not(:has([class*="_modal"])):not(:has([class*="_portal"])) [data-dockkit-float] {
...
html body:not([data-mpw-sblur-off]):not([data-mpw-header-blur-off]):not(:has([class*="_overlay"])):not(:has([class*="_modal"])):not(:has([class*="_portal"])) .pI_x6G_sidebarCol,
html body:not([data-mpw-sblur-off]):not([data-mpw-header-blur-off]):not(:has([class*="_overlay"])):not(:has([class*="_modal"])):not(:has([class*="_portal"])) [class*="sidebarCol"]:not([data-sidebar-right-panel]),
html body:not([data-mpw-sblur-off]):not([data-mpw-header-blur-off]):not(:has([class*="_overlay"])):not(:has([class*="_modal"])):not(:has([class*="_portal"])) .wSkVaW_header {
		...
		function setupSblurObserver() {
			...
			const check = () => {
				try {
					...
					const hasDlg = Array.from(document.querySelectorAll('[class*="_overlay"], [class*="_modal"]')).some(isFixedOverlay)
